...
const createCheckoutSession = async (projectId: string, clientId: string) => {
  ...
  //         product_data: {
  //           name: `Payment for ${project.title}`,
  //           description: `Total: $${project.totalPaid} | Platform Fee (10%): $${(platformFeeCents/100).toFixed(2)} | Admin Fee (10%): $${adminFeeFromEngineerBudget.toFixed(2)} | Engineers (90%): $${engineerPool.toFixed(2)}`,
  //         },
  //       },
  //       quantity: 1,
  //     },
  ...
  //   payment_intent_data: {
  //     transfer_group: transferGroup,
  //     // Platform fee হিসেবে application_fee (totalPaid এর 10%)
  ...
  //     projectId,
  //     clientId,
  //     adminFee: adminFeeFromEngineerBudget.toString(), // ✅ approvedEngineersTotalAmount এর 10%
  //     engineerPool: engineerPool.toString(), // ✅ approvedEngineersTotalAmount এর 90%
  //     totalAllocatedHours: totalAllocatedHours.toString(),
  //     totalEngineerCost: totalEngineerCost.toString(),
  //     scalingFactor: scalingFactor.toString(),
  //     platformFee: (platformFeeCents / 100).toString() // ✅ totalPaid এর 10%
  //   },
  // });
